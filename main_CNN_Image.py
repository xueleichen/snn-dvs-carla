...
from dataloader import get_DVSDataloader, get_RGBDataloader, get_ImageDataloader
...
train_dataloader = get_ImageDataloader("./rgb_train.txt", 12, num_workers=4, shuffle=True)
test_dataloader = get_ImageDataloader("./rgb_test.txt", 1, num_workers=4, shuffle=True)
test_in_dataloader = get_ImageDataloader("./rgb_test_in.txt", 1, num_workers=4, shuffle=True)
test_out_dataloader = get_ImageDataloader("./rgb_test_out.txt", 1, num_workers=4, shuffle=True)
